    ...
    <div className="bg-paleblue">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 max-w-7xl mx-auto p-3 mt-20">
          <h1 className="max-w-xl text-5xl leading-tight font-bold text-black">
            Never run out of essential drugs to manage your condition
          </h1>
          <p className="text-black mt-2 text-xl">
            Buy prescribed drugs to better manage your health
          </p>
          <button
            onClick={handleClick} type="button" className="bg-blue text-white rounded-md px-5 p-3 mt-10 hover:bg-light-blue transition-all"
          >
            Upload Prescription
          </button>
        </div>
